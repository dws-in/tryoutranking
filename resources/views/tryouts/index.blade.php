<x-app-layout>
    <x-slot name="header">
        ...
        <p style="font-size: small;">Never join a tryout? Let's find a tryout that match your need!</p>
    </x-slot>

    <div>
        <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="block mb-8">
                <a href="{{ route('tryouts.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Add</a>
            </div>
