            ...
            <div class="md:flex">
                <div class="w-full">
                    ...
                    <form action="{{ route('myTryout.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="p-3">
                            <div class="mb-2"> <span class="text-sm">Title</span> <input type="text"
                                    class="h-12 px-3 w-full border-gray-200 border rounded focus:outline-none focus:border-gray-300" name="title">
                            </div>
                            ...
                            <div class="mt-3 text-center pb-3"> <button
                                    class="w-full h-12 text-lg w-32 bg-blue-600 rounded text-white hover:bg-blue-700">Create</button>
                            </div>
                        </div>
                        <input type="hidden" value="{{$tryout->id}}" name="tryout_id">
                    </form>
                </div>
            </div>
        </div>
